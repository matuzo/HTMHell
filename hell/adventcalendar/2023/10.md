...
For most situations, you should accept that the slotted elements keep the styling they're given.

### But what if I want to have my cake and eat it?

We effectively only have 1 way to override the style of slotted content for the Shadow DOM. Select both the shadowed element and the slotted elements from within the document and style it from there.
...
I confess adding these additional styles to the document is a bit weird. However, bundling these with the main styles is fine in most situations.
