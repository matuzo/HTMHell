...
<!-- Eric: It appears you're using smart double quotes in code samples (ex: “). We'll need to update them to be straight double quotes (ex: "). -->
...
<!-- From a previous comment, we might also want some language here about how this is mostly an academic curiosity, and should not be used in production. See: https://www.scottohara.me/blog/2019/07/10/the-output-element.html#quirks-with-the-output-element -->
