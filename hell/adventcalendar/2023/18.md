...
<!-- I might encourage a slight restructuring of this paragrah. I think the narrative being 1. Node doesn't allow for browser-run JS testing, 2. My career and its speciality could benefit from TDD, and then 3. At first it seemed like this wouldn't be possible. -->
