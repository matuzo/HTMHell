...
<!-- Manuel: WOW! I'm impressed by the quality of this post and the amount of time you've invested in creating demos. Thanks a lot! 🦞 -->
<!-- Saptak: 100% agree with Manuel on this! Really well structured post -->
...
<!-- Manuel: Should we link PSI here? https://pagespeed.web.dev/ -->
...
<!-- Saptak: I feel linking CRUX, CWV, Pagespeed Insights, Google Search Console, etc. might be helpful for readers as references? -->
...
<!-- Saptak: "Aim for an LCP of 2.5 seconds or less" Can we link to some research around this? Maybe https://web.dev/articles/defining-core-web-vitals-thresholds#achievability? -->
...
<!-- Manuel: Is it only JS that can mess with INP or is it also about server response times? -->
...
<!-- Saptak: "it’ll replace the similar First Input Delay (FID) in March 2024" can we link to maybe https://web.dev/blog/inp-cwv for this statement? -->
...
<!-- Saptak: Maybe can link the above sentence to https://web.dev/articles/defining-core-web-vitals-thresholds#achievability_3? for further reading into the methodology used to determine these numbers. -->
...
<!-- Manuel: It's worth mentioning that it's not just about the benefits of http2 but also because shared caching isn't a thing anymore: https://www.stefanjudis.com/notes/say-goodbye-to-resource-caching-across-sites-and-domains/ -->
