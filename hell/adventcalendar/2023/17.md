...
<!-- Man, I wish the ⭐⭐⭐⭐🐴 bug was better documented, because I'd love to link to it here. -->
...
<!-- I disagree here. It's a frustrating pattern and I wish more people knew about what Mayank is about to get into, rather than not spending the effort to create better validation patterns. -->
...
<!-- Yeah, I wonder if it's worth getting into more detail here about `aria-disabled`'s nuance? -->
