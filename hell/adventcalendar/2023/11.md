...
<!-- Manuel: Why exactly is JS the "the most powerful language"? I feel like this needs explanation because _powerful_ can mean a lot and mean different things 
depening on the context-->
...
<!-- Could we link to resources for the examples you list off for the curious as a jumping off point? -->
