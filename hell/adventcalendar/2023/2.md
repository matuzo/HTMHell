...
<!-- Manuel: "deemed insignificant" <-- What is this statement based on? -->
...
<!-- Manuel: I agree with Saptak, and I would also add "Common Mistakes and how to avoid them" to the list. You're saying the same things multiple times. You can easily cut 1/3 or even half of the blog post. Some examples:
