...
For example, a `<button>`-element is automatically included in the focus order and will have event listeners attached, an element with `role="button"` will _not_ have those characteristics by default.
...
## Last words
We <cite>[already know](https://webaim.org/projects/million/#aria)</cite>:
