...
This is wrong. The documentation says that the anchor element must not contain any other interactive element, so `<button>` elements cannot live inside the `<a>` element. If we validate the code against the [HTML validator](https://validator.w3.org/nu/), we can see that it's invalid.
...
<p>- <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#properties">MDN</a></p>
...
Instead, use only allowed elements inside list elements.
...
<p>- <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/legend">MDN</a></p>
