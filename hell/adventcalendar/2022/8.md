...
author_bio: "Lara is a software developer at scale.at always striving for great user experience. She wants to make the web a better place while always improving her knowledge about the ins and outs of HTML and CSS."
date: 2022-12-08
tags: advent2022
active: true
author_links:
  - label: "scale Website"
    url: "https://www.scale.at"
    link_label: "www.scale.at"
  - label: "scale Blog"
...
This task comes with a few challenges and most of the time there’s no one correct way to do it. In this article, I’m going to describe how I personally approach those kinds of project.
...
I’m not going into every little detail here, there are [other articles and tutorials about that](https://www.matuzo.at/blog/html-boilerplate/). We are going to change the page’s title to `<title>The Weekly Prophet – Magical News from the Wizarding World</title>` (according to the text in the wireframe) and focus on the document’s `<body>` from now on.
