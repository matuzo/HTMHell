...
<figure class="u-mb">
  ...
  <figcaption>Two mobile browser visualizations positioned next to each other. One has an element sized to be <code>100svh</code> (left, green) and the other <code>100lvh</code> (right, blue). The blue dotted line represents the Layout Viewport.</figcaption>
</figure>
