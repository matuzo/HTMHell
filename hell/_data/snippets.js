module.exports = {
  ...
  i_elem: 'The `i` element represents a span of text in an alternate voice or mood, or otherwise offset from the normal prose in a manner indicating a different quality of text.<sup><a href="#resources">2</a></sup> If you just want italic text, use `font-style: italic;` in CSS.',
  ...
  noalt: "There’s no text alternative for the image. Screen readers may annouce the filename instead.",
