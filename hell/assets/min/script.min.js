...
var request=new XMLHttpRequest;request.open("GET","/assets/logo.txt",!0),request.onload=function(){200<=this.status&&this.status<400&&(document.querySelector(".site-logo").innerHTML=this.response,setTimeout(function(){document.documentElement.classList.add("site--loaded")},0))},request.send();let marqueeText=document.querySelector(".marquee-content-3"),button=document.querySelector(".btn-marquee");button&&button.addEventListener("click",()=>{"running"==marqueeText.style.animationPlayState?(marqueeText.style.animationPlayState="paused",button.innerText="Play",button.ariaPressed="true"):(marqueeText.style.animationPlayState="running",button.innerText="Pause",button.ariaPressed="false")});